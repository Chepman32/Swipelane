...
const SPINE_TIMELINE_LAYOUT_INPUT: SpineTimelineStepLayoutInput[] = [
  {
    ...
    labelAnchor: { x: 0.12, y: 0.13, maxWidth: 0.34, align: 'left', font: 'titleLarge' },
    detailAnchor: {
      x: 0.12,
      y: 0.175,
      maxWidth: 0.34,
  ...
  },
  {
    ...
    labelAnchor: { x: 0.57, y: 0.30, maxWidth: 0.34, align: 'left', font: 'titleLarge' },
    detailAnchor: {
      x: 0.57,
      y: 0.345,
      maxWidth: 0.34,
  ...
  },
  {
    ...
    labelAnchor: { x: 0.57, y: 0.50, maxWidth: 0.34, align: 'left', font: 'titleLarge' },
    detailAnchor: {
      x: 0.57,
      y: 0.545,
      maxWidth: 0.34,
  ...
  },
  {
    ...
    labelAnchor: { x: 0.12, y: 0.67, maxWidth: 0.34, align: 'left', font: 'titleLarge' },
    detailAnchor: {
      x: 0.12,
      y: 0.715,
      maxWidth: 0.34,
  ...
  },
  {
    ...
    labelAnchor: { x: 0.57, y: 0.84, maxWidth: 0.34, align: 'left', font: 'titleLarge' },
    detailAnchor: {
      x: 0.57,
      y: 0.885,
      maxWidth: 0.34,
