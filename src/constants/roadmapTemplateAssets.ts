...
> = {
  ...
  vertical_icon_rail_5: {
    ...
    textSlots: [
      {
        circleId: 'c1',
        label: { x: 0.12, y: 0.18, maxWidth: 0.34, align: 'left', color: '#111111', font: 'title' },
        detail: {
          x: 0.12,
          y: 0.225,
          maxWidth: 0.34,
      ...
      {
        circleId: 'c2',
        label: { x: 0.56, y: 0.35, maxWidth: 0.34, align: 'left', color: '#111111', font: 'title' },
        detail: {
          x: 0.56,
          y: 0.395,
          maxWidth: 0.34,
      ...
      {
        circleId: 'c3',
        label: { x: 0.56, y: 0.53, maxWidth: 0.34, align: 'left', color: '#111111', font: 'title' },
        detail: {
          x: 0.56,
          y: 0.575,
          maxWidth: 0.34,
      ...
      {
        circleId: 'c4',
        label: { x: 0.12, y: 0.70, maxWidth: 0.34, align: 'left', color: '#111111', font: 'title' },
        detail: {
          x: 0.12,
          y: 0.745,
          maxWidth: 0.34,
      ...
      {
        circleId: 'c5',
        label: { x: 0.56, y: 0.86, maxWidth: 0.34, align: 'left', color: '#111111', font: 'title' },
        detail: {
          x: 0.56,
          y: 0.905,
          maxWidth: 0.34,
  ...
  road_track_6: {
    ...
    textSlots: [
      {
        circleId: 'c1',
        label: { x: 0.15, y: 0.53, maxWidth: 0.28, align: 'left', color: '#141414', font: 'title' },
        detail: {
          x: 0.15,
          y: 0.575,
          maxWidth: 0.31,
      ...
      {
        circleId: 'c2',
        label: { x: 0.77, y: 0.74, maxWidth: 0.25, align: 'left', color: '#141414', font: 'title' },
        detail: {
          x: 0.77,
          y: 0.785,
          maxWidth: 0.29,
      ...
      {
        circleId: 'c3',
        label: { x: 0.04, y: 0.40, maxWidth: 0.28, align: 'left', color: '#141414', font: 'title' },
        detail: {
          x: 0.04,
          y: 0.445,
          maxWidth: 0.31,
      ...
      {
        circleId: 'c4',
        label: { x: 0.66, y: 0.35, maxWidth: 0.27, align: 'left', color: '#141414', font: 'title' },
        detail: {
          x: 0.66,
          y: 0.395,
          maxWidth: 0.30,
      ...
      {
        circleId: 'c5',
        label: { x: 0.05, y: 0.15, maxWidth: 0.28, align: 'left', color: '#141414', font: 'title' },
        detail: {
          x: 0.05,
          y: 0.195,
          maxWidth: 0.31,
      ...
      {
        circleId: 'c6',
        label: { x: 0.76, y: 0.21, maxWidth: 0.25, align: 'left', color: '#141414', font: 'title' },
        detail: {
          x: 0.76,
          y: 0.255,
          maxWidth: 0.29,
  ...
  radial_spokes_8: {
    ...
    textSlots: [
      {
        circleId: 'c1',
        label: { x: 0.73, y: 0.15, maxWidth: 0.24, align: 'left', color: '#8B124F', font: 'title' },
        detail: {
          x: 0.73,
          y: 0.195,
          maxWidth: 0.24,
      ...
      {
        circleId: 'c2',
        label: { x: 0.74, y: 0.36, maxWidth: 0.24, align: 'left', color: '#A71111', font: 'title' },
        detail: {
          x: 0.74,
          y: 0.405,
          maxWidth: 0.24,
      ...
      {
        circleId: 'c3',
        label: { x: 0.73, y: 0.55, maxWidth: 0.24, align: 'left', color: '#4C8D4F', font: 'title' },
        detail: {
          x: 0.73,
          y: 0.595,
          maxWidth: 0.24,
      ...
      {
        circleId: 'c4',
        label: { x: 0.73, y: 0.79, maxWidth: 0.24, align: 'left', color: '#2D85B7', font: 'title' },
        detail: {
          x: 0.73,
          y: 0.835,
          maxWidth: 0.24,
      ...
      {
        circleId: 'c5',
        label: { x: 0.03, y: 0.79, maxWidth: 0.24, align: 'left', color: '#C88703', font: 'title' },
        detail: {
          x: 0.03,
          y: 0.835,
          maxWidth: 0.24,
      ...
      {
        circleId: 'c6',
        label: { x: 0.03, y: 0.55, maxWidth: 0.24, align: 'left', color: '#C88703', font: 'title' },
        detail: {
          x: 0.03,
          y: 0.595,
          maxWidth: 0.24,
      ...
      {
        circleId: 'c7',
        label: { x: 0.03, y: 0.36, maxWidth: 0.24, align: 'left', color: '#6E3C9B', font: 'title' },
        detail: {
          x: 0.03,
          y: 0.405,
          maxWidth: 0.24,
      ...
      {
        circleId: 'c8',
        label: { x: 0.03, y: 0.15, maxWidth: 0.24, align: 'left', color: '#C88703', font: 'title' },
        detail: {
          x: 0.03,
          y: 0.195,
          maxWidth: 0.24,
