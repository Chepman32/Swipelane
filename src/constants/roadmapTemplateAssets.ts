...
export const ROADMAP_TEMPLATE_IMAGES = {
  ...
  radial_spokes_8: require('../assets/templates/IMG_0580.png'),
} as const;
...
> = {
  ...
  vertical_icon_rail_5: {
    ...
    textSlots: [
      {
        circleId: 'c1',
        label: { x: 0.03, y: 0.08, maxWidth: 0.34, align: 'left', color: '#C88703', font: 'title' },
        detail: {
          x: 0.03,
          y: 0.125,
          maxWidth: 0.34,
      ...
      {
        circleId: 'c2',
        label: { x: 0.68, y: 0.24, maxWidth: 0.30, align: 'left', color: '#EC6AA0', font: 'title' },
        detail: {
          x: 0.68,
          y: 0.285,
          maxWidth: 0.30,
      ...
      {
        circleId: 'c3',
        label: { x: 0.03, y: 0.41, maxWidth: 0.34, align: 'left', color: '#6E3C9B', font: 'title' },
        detail: {
          x: 0.03,
          y: 0.455,
          maxWidth: 0.34,
      ...
      {
        circleId: 'c4',
        label: { x: 0.68, y: 0.58, maxWidth: 0.30, align: 'left', color: '#A71111', font: 'title' },
        detail: {
          x: 0.68,
          y: 0.625,
          maxWidth: 0.30,
      ...
      {
        circleId: 'c5',
        label: { x: 0.03, y: 0.75, maxWidth: 0.34, align: 'left', color: '#F4C20D', font: 'title' },
        detail: {
          x: 0.03,
          y: 0.795,
          maxWidth: 0.34,
