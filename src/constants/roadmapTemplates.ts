...
export const VERTICAL_ICON_RAIL_5_TEMPLATE: RoadmapTemplate = {
  ...
  circles: [
    ...
    { id: 'c5', position: { x: 0.52, y: 0.73 }, radius: 0.05, labelPosition: 'bottom' },
    { id: 'c6', position: { x: 0.36, y: 0.65 }, radius: 0.05, labelPosition: 'bottom' },
    { id: 'c7', position: { x: 0.24, y: 0.49 }, radius: 0.05, labelPosition: 'bottom' },
    { id: 'c8', position: { x: 0.35, y: 0.24 }, radius: 0.05, labelPosition: 'bottom' },
  ],
  connectors: [],
  defaultStrokeColor: ROADMAP_DEFAULTS.strokeColor,
  defaultStrokeWidth: ROADMAP_DEFAULTS.strokeWidth,
