...
export const ROAD_TRACK_6_TEMPLATE: RoadmapTemplate = {
  ...
  circleCount: 6,
  circles: [
    { id: 'c1', position: { x: 0.12, y: 0.68 }, radius: 0.06, labelPosition: 'bottom' },
    ...
    { id: 'c5', position: { x: 0.38, y: 0.225 }, radius: 0.06, labelPosition: 'bottom' },
    { id: 'c6', position: { x: 0.905, y: 0.21 }, radius: 0.06, labelPosition: 'bottom' },
  ],
  connectors: [],
  defaultStrokeColor: ROADMAP_DEFAULTS.strokeColor,
  defaultStrokeWidth: ROADMAP_DEFAULTS.strokeWidth,
